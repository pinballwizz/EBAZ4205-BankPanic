...
wire [4:0]  pal_addr = {back,col};

wire [12:0] gfx_rom1_addr;
wire [12:0] gfx_rom2_addr;
wire [12:0] gfx_rom3_addr;
wire [12:0] gfx_rom4_addr;
wire [12:0] gfx_rom5_addr;
wire [12:0] gfx_rom6_addr;
...
fg_color_lut fg_color_lut(
.clk(clk_sys),
.addr(rc_addr),
.data(fgdata)
);

assign rcol = fgdata[3:0];

bg_color_lut bg_color_lut(
.clk(clk_sys),
.addr(sc_addr),
.data(bgdata)
);

assign scol = bgdata[3:0];
