Bank Panic Arcade for the EBAZ-4205 ZYNQ-7010 FPGA Board. Pinballwiz.org 2026
Code from Pierco.
...
Build:
* Obtain correct roms file for Bank Panic (see scripts in tools folder for rom details).
* Unzip rom files to the tools folder.
* Run the make Bank Panic proms script in the tools folder.
* Place the generated prom files inside the proms folder.
* Open the EBAZ4205-BankPanic project file using Vivado (v2022.2 or silimar is recommended)
